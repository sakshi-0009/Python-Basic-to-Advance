...
class TkinterLibraryApp:
    def __init__(self):
        self.root = tk.Tk()
        self.screen_width = self.root.winfo_screenwidth()
        self.screen_height = self.root.winfo_screenheight()
        self.root.title('Tkinter Library App')
    ...
    def setup_ui(self):
        ...
        self.button_label = ttk.Button(self.left_frame,text='Tkinter Fonts',style="Rounded.TButton",command=self.show_font_tab)
        self.button_label.pack()
        self.button_label.place(x=60,y=350,anchor='nw')
        
        # Load and display an image
        script_directory = os.path.dirname(os.path.abspath(__file__))
        img_path = os.path.join(script_directory,"../assets/sakshi.jpg")
        ...
        self.original_label_text = "Hello Everyone!! \n Welcome to Font Library Application."
        ...
        self.right_label.place(x=55,y=300,anchor='nw')
    ...
    def show_font_tab(self):
        if self.font_library_opened:
            ...
            self.heading_label = tk.Label(self.right_frame,text=' Tkinter Font Library',background='#BCD2E8',font=('Poppins',20,'bold'),fg=tk_color)
